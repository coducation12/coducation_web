...
async function normalize() {
    console.log('--- FINAL DATA NORMALIZATION (TO NO SPACE) ---');
    ...
    if (e1) console.error('광양 코딩 -> 광양코딩 변환 실패:', e1);
    else console.log(`광양 코딩 -> 광양코딩 변환 완료 (${c1} rows)`);
    ...
    else console.log(`코딩 메이커 -> 코딩메이커 변환 완료 (${c2} rows)`);
