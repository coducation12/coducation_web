...
const navItems = [
  { href: "/dashboard/admin", label: "대시보드", icon: <UserCircle className="w-5 h-5" /> },
  { href: "/dashboard/admin/curriculum", label: "학습하기", icon: <BookOpen className="w-5 h-5" /> },
  { href: "/dashboard/admin/typing", label: "타자연습", icon: <Keyboard className="w-5 h-5" /> },
