  ...
  return (
    <div className="w-full h-full flex flex-col p-6">
      <div className="flex items-center mb-8">
        ...
        <StudentHeading size="h1">한글 타자</StudentHeading>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ExerciseCard
            title="자리연습"
            description="한글 자음과 모음의 기본 위치를 익혀보세요"
            icon={<Type className="w-full h-full" />}
            href="/dashboard/student/typing/korean/basic"
          />
          
          <ExerciseCard
            title="낱말연습"
            description="한글 단어를 타이핑하여 어휘력을 키워보세요"
            icon={<FileText className="w-full h-full" />}
            href="/dashboard/student/typing/korean/word"
          />
          
          <ExerciseCard
            title="장문연습"
            description="긴 문장을 타이핑하여 실력을 향상시켜보세요"
            icon={<BookOpen className="w-full h-full" />}
            href="/dashboard/student/typing/korean/sentence"
          />
        </div>
      </div>
    </div>
