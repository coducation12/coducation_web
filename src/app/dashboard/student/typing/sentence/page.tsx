...
const koreanSentences = [
  ...
  '중요한 건 꺾이지 않는 마음이다. 중꺾마.',
  '진정한 자유는 모든 것을 잃었을 때 찾아온다.',
  '기적은 노력의 또 다른 이름이다. 노력하자.',
  '사랑은 누군가를 너보다 먼저 생각하는 거야.',
  '오늘을 잡아라. 인생을 특별하게 만들어라.',
  '용기는 두려움이 없는 게 아니라, 이겨내는 것이다.',
  '할 수 있다고 믿는 순간, 이미 절반은 성공한 거야.',
  '가는 말이 고와야 오는 말이 곱다. 좋게좋게 말하자.',
  '천 리 길도 한 걸음부터 시작한다. 시작이 반이다.',
  '세 살 버릇 여든까지 간다. 습관이 중요하다.',
  '고생 끝에 낙이 올 수도 있고 안올 수도 있다.',
  '돌다리도 두들겨 보고 건너라. 무너지기도 한다.',
